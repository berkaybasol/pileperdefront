          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md border border-white/10 p-6 lg:p-8 mb-4 lg:mb-6 group hover:border-white/20 transition-all duration-500">
              <div className="flex items-start gap-3 lg:gap-4">
                ...
                <div>
                  ...
                  >
                    <span className="text-xs lg:text-sm">{isEnglish ? 'View on Google Maps' : <>Google Maps&apos;te Görüntüle</>}</span>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-6">
              ...
              <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md border border-white/10 p-4 sm:p-6 lg:p-8 group hover:border-white/20 transition-all duration-500">
                ...
                <h3 className="text-white font-extralight text-sm sm:text-base lg:text-lg mb-2 lg:mb-3 uppercase tracking-wider">{isEnglish ? 'Telephone' : 'Telefon'}</h3>
              ...
              <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md border border-white/10 p-4 sm:p-6 lg:p-8 group hover:border-white/20 transition-all duration-500">
                ...
                <h3 className="text-white font-extralight text-sm sm:text-base lg:text-lg mb-2 lg:mb-3 uppercase tracking-wider">{isEnglish ? 'Email' : 'E-posta'}</h3>
              ...
              <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md border border-white/10 p-4 sm:p-6 lg:p-8 group hover:border-white/20 transition-all duration-500">
                ...
                <h3 className="text-white font-extralight text-sm sm:text-base lg:text-lg mb-2 lg:mb-3 uppercase tracking-wider">{isEnglish ? 'Opening Hours' : 'Çalışma Saatleri'}</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <input
                    ...
                    placeholder={isEnglish ? 'Full name' : 'İsim Soyisim'}
                    autoComplete="name"
                ...
                {submitStatus === 'error' && (
                  <p className="text-xs text-red-400 text-center mt-3">
                    {isEnglish ? 'Your enquiry could not be saved. Please try again.' : <>Talep kaydedilemedi. Lutfen backend&apos;in calistigini kontrol edip tekrar deneyin.</>}
                  </p>
                )}
