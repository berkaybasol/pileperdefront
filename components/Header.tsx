...
const mobileSocialAriaLabels: Record<typeof socialLinks[number]['name'], string> = {
  WhatsApp: 'WhatsApp ile iletişime geç',
  Instagram: 'Instagram hesabımızı aç',
  Pinterest: 'Pinterest hesabımızı aç',
  Facebook: 'Facebook hesabımızı aç',
}

const mobileSocialOrder = ['WhatsApp', 'Instagram', 'Pinterest', 'Facebook'] as const
...
const Header = () => {
    ...
    },
    {
      ...
      content: {
        models: [
          ...
          { title: 'Çocuk Odası Perde Modelleri', image: '/api/public/media/images/92d067f9-f14e-45da-89fb-901f775d61b3/file', href: '/model-perdeler/cocuk-perde' },
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-2 min-[375px]:px-3 min-[430px]:px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link href="/" className="relative z-10 flex-shrink-0">
              <Image
                ...
                width={140}
                height={48}
                className="h-auto w-[76px] min-[375px]:w-[100px] min-[430px]:w-[120px] lg:h-10 lg:w-auto"
                priority
              />
            </Link>
                            ...
                            <div className="grid grid-cols-6 gap-6 mb-6">
                              {item.content.corporate.map((corp) => (
                                <Link key={corp.title} href={corp.href} className="group/item">
                                  ...
                                  <h3 className="text-xs font-extralight text-white group-hover/item:text-gray-400 transition-colors tracking-wider text-center">
                                    {corp.title}
                                  </h3>
                                </Link>
                              ))}
            ...
            <div className="mr-3 flex items-center lg:hidden" aria-label="Sosyal medya bağlantıları">
              {mobileSocialOrder.map((name) => {
                ...
                return (
                  <a
                    ...
                    aria-label={mobileSocialAriaLabels[social.name]}
                    className="inline-flex h-7 w-7 min-[375px]:h-8 min-[375px]:w-8 min-[430px]:h-9 min-[430px]:w-9 items-center justify-center text-gray-400 transition-colors duration-200 hover:text-white focus-visible:text-white"
                  >
                    <svg aria-hidden="true" className="h-3.5 w-3.5 min-[375px]:h-4 min-[375px]:w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="lg:hidden inline-flex h-11 w-11 flex-shrink-0 items-center justify-center text-white"
            >
