...
const canonicalUrl = 'https://pileperde.com.tr/model-perdeler/modern-perde'
const breadcrumbItems: BreadcrumbItem[] = [
  { name: 'Ana Sayfa', url: '/' },
  { name: 'Perde Modelleri', url: '/perde-modelleri' },
  { name: 'Modern Perde', url: '/model-perdeler/modern-perde' },
]
          ...
          <div className="mx-auto max-w-xl rounded-2xl border border-white/10 bg-white/[0.035] px-5 py-5 text-center backdrop-blur-md">
            ...
            <div className="flex flex-col items-stretch justify-center gap-2.5 sm:flex-row sm:items-center">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/15 bg-white px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-gray-200"
              >
      ...
      <section className={`relative border-t border-white/5 py-20 ${styles.gallerySection}`}>
        <div className="container mx-auto px-6">
          <ProductGalleryHeading
            ...
            fallbackTitle="Modern Perde Modelleri"
