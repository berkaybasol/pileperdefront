        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Çocuk Perde</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Perdelere Masalsı Bir Dokunuş... Pile Perde Çocuk Koleksiyonumuz; çocuklarınızın sağlığı ve güvenliği için
              tüm gereklerin düşünüldüğü, tamamı antibakteriyel olan, geniş tarz ve model çeşitliliğine sahip özel bir
              koleksiyondur.
            </p>
          </div>
        </div>
