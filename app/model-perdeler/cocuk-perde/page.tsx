          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-4">
              <Link
                ...
                className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-black overflow-hidden transition-all duration-300 hover:gap-4 rounded-xl"
              >
              ...
              <Link
                ...
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-emerald-950/70 text-white hover:bg-emerald-900/80 transition-all duration-300 rounded-xl"
              >
