...
const canonicalUrl = 'https://pileperde.com.tr/model-perdeler/cati-kati-perde'
const breadcrumbItems: BreadcrumbItem[] = [
  { name: 'Ana Sayfa', url: '/' },
  { name: 'Perde Modelleri', url: '/perde-modelleri' },
  { name: 'Çatı Katı Perde', url: '/model-perdeler/cati-kati-perde' },
]
      ...
      <section className={`relative pb-14 ${styles.contactSection}`}>
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-xl rounded-2xl border border-white/10 bg-white/[0.035] px-5 py-5 text-center backdrop-blur-md">
            <p className="mb-4 text-sm font-light tracking-wide text-gray-300">Özel ölçü ve fiyat bilgisi için bize ulaşın.</p>
      ...
      <section className={`relative border-t border-white/5 ${styles.gallerySection}`}>
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extralight text-white">Çatı Katı Perde Modelleri</h2>
          </div>
