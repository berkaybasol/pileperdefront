        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">İp Perde</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              İp Perde tek başına kullanıldığında standart bir tül perdenin işlevini görür, dışarından içeriye giren
              ışık miktarı tülle aynıdır. 10 metre yükseklikte dilediğiniz genişlikte ve özel ölçülerde üretilebilmektedir.
              Birçok değişik türde İp Perde modeli vardır.
            </p>
          </div>
        </div>
      </section>
