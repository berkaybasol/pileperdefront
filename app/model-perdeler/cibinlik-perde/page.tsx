        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Cibinlik Perde</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Eski dönemlerde cibinlik, lüks ve ihtişam sembolü olarak kabul edildiği için özellikle yatak odalarının
              dekorasyonlarında vazgeçilmez bir öğeydi. Günümüzde, klasik/modern yatak odası ve çocuk odalarında dekoratif
              Cibinlik Perde çokça tercih ediliyor.
            </p>
          </div>
        </div>
      </section>
