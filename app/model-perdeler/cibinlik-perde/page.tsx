...
const productAdvantages = [
  'Klasik ve modern yatak odaları için dekoratif tasarımlar',
  'Çok geniş renk, model ve aksesuar yelpazesi',
  'Klasik, altın, varak, gümüş ve siyah cibinlik taçları',
  'Profesyonel tasarım ekibi ile özel proje desteği',
  'Rekabetçi fiyatlarla kaliteli ürün sunumu'
]
        ...
        <div className="container mx-auto px-6 text-center">
          <div>
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Cibinlik Perde Modelleri Hakkında Sorularınız mı var?
            </h3>
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto font-light">
              ...
              uygun cibinlik perde modelleri hakkında bilgi alabilir ve sipariş verebilirsiniz.
            </p>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
              <Link
                href="tel:+903122417272"
                className="inline-flex items-center justify-center gap-2 min-h-11 px-5 py-2.5 rounded-xl border border-white/15 bg-white text-black text-sm font-medium transition-colors hover:bg-gray-200"
              >
                <span>0312 241 72 72</span>
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 min-h-11 px-5 py-2.5 rounded-xl border border-emerald-400/20 bg-emerald-950/70 text-emerald-100 text-sm font-medium transition-colors hover:bg-emerald-900/80"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md border border-white/10">
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Profesyonel tasarım ekibimiz, dekorasyonunuzun konseptine ve beklentilerinize göre proje oluşturmaktadır.
                  Cibinlik taçları, yarım ay şeklinde duvara ya da yatağın tavanı etrafında çerçeve çizecek şekilde uygulanabilir.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Cibinlik perde taçları; klasik, altın, varak, gümüş ve siyah gibi çok geniş renk model ve aksesuar yelpazesine
                  sahiptir. Cibinlik çeşitlerini, tasarımlarına göre farklı kategorilerde inceleyebiliriz.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Perde Aksesuarları sekmesinden cibinlik perde taçlarını inceleyebilirsiniz. Cibinlik perde tac fiyatları ürün
                  cinsine türüne göre değişiklik göstermektedir.
                </p>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {['Dekoratif', 'Klasik', 'Altın Taç', 'Varak', 'Gümüş', 'Siyah', 'Lüks', 'İhtişam'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-900/20 to-cyan-900/20 backdrop-blur-md border border-blue-500/20">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Cibinlik perde tac fiyatları, ürün cinsine ve türüne göre değişiklik göstermektedir. Klasik, altın, varak,
                gümüş ve siyah gibi geniş renk ve aksesuar seçenekleri ile Pile Perde, rekabetçi fiyatlarla kaliteli cibinlik
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-md border border-purple-500/20">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Cibinlik perdelerimizi aşağıdaki alanlarda kullanarak mekanlarınıza lüks ve ihtişamlı bir dokunuş ekleyebilirsiniz.
                Her bir mekan için profesyonel tasarım ve özel uygulama çözümleri sunuyoruz.
              </p>
