...
const productAdvantages = [
  ...
  'Cam Balkon kanatları hareket ederken, perdeniz de birlikte hareket eder ve kullanım kolaylığı sağlar',
  'Zengin sıra dışı ve şık tasarımlar oluşturmanızı sağlar',
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Plise Cam Balkon Perdesi, çok güçlü yapışkanlı veya balon profiline vidalanarak uygulanabilir.
                  Cam balkon profil rengine uygundur. Profil renk seçenekleri; beyaz, krem, alüminyum, sütlü kahve,
                  antrasit ve acı kahve olarak altı renk seçeneği ile sunulmaktadır.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Plise perde cam balkon dışında eviniz ve ofisiniz sabit hareketli kapı, pencerelerine de uygulanabilir.
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {['Plise Sistem', 'Karartma', 'Tül', 'İkili Sistem', '6 Renk', '36 Ay Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Plise Cam Balkon Perdesi fiyatları, ürün cinsine ve türüne göre değişiklik göstermektedir.
                Pile Perde, rekabetçi fiyatları ile projelerinizi sorunsuz şekilde tamamlamanızı sağlar.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Cam balkon perdeleri her türlü mekan için uygun perde sistemidir. Modern ve pratik yapısı ile yaşam
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Cam Balkon Perde Hakkında Sorularınız mı var?
            </h3>
