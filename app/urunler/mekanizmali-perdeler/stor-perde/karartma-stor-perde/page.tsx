        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Karartma Stor Perde</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Karartma Stor Perde (Blackout) mekanik sistem perdeler, içerisinde kullanım şeklinin pratikliği ve ürün çeşitliliği
              nedeniyle en çok tercih edilen iç cephe mekanik perde sistemidir. Benzersiz desen ve renk doku ile birçok kumaş
              çeşitleri mevcuttur her ortama uyum sağlayan çok geniş bir yelpazeye sahiptir.
            </p>
          </div>
        </div>
      </section>
