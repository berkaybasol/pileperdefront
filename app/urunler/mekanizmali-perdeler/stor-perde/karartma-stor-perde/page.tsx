...
const canonicalUrl = 'https://pileperde.com.tr/urunler/mekanizmali-perdeler/stor-perde/karartma-stor-perde'
const breadcrumbItems: BreadcrumbItem[] = [
  ...
  { name: 'Karartma Stor Perde', url: '/urunler/mekanizmali-perdeler/stor-perde/karartma-stor-perde' },
]
...
const productImages: ProductGalleryImage[] = [
  { id: 1, src: '/api/public/media/images/3527def1-7573-4032-99f9-edb5082959eb/file', alt: 'Karartma blackout stor perde', title: 'Karartma Blackout Stor Perde' },
  { id: 2, src: '/api/public/media/images/744ea46c-25ff-426c-bb2a-99c539418951/file', alt: 'Blackout stor perde', title: 'Blackout Stor Perde' },
  { id: 3, src: '/api/public/media/images/06eccd8e-50bb-4832-b78d-837f4f0eaf78/file', alt: 'Karartma stor perde modeli', title: 'Karartma Stor Perde Modeli' },
  { id: 4, src: '/api/public/media/images/88c2fb87-1095-49aa-b66f-bae422199add/file', alt: 'Karartma stor perde', title: 'Karartma Stor Perde' },
  { id: 5, src: '/api/public/media/images/b76b0796-c696-476a-b7fd-d25b83f035ae/file', alt: 'Blackout stor perde sistemi', title: 'Blackout Stor Perde Sistemi' }
]

const PRODUCT_GALLERY_PAGE_KEY = 'product-gallery-urunler-mekanizmali-perdeler-stor-perde-karartma-stor-perde'

const defaultHeroCopy = {
  breadcrumbLabel: "Karartma Stor Perde",
  eyebrow: "Stor Perde Koleksiyonu",
  title: "Karartma Stor Perde",
  highlightedTitle: "Blackout",
  description: "Karartma Stor Perde (Blackout) mekanik sistem perdeler, içerisinde kullanım şeklinin pratikliği ve ürün çeşitliliği nedeniyle en çok tercih edilen iç cephe mekanik perde sistemidir. Benzersiz desen ve renk doku ile birçok kumaş çeşitleri mevcuttur her ortama uyum sağlayan çok geniş bir yelpazeye sahiptir.",
}

const productAdvantages = [
  'Basit mekanizması sayesinde minimum arıza sorunu çıkaran perde sistemleridir',
  'Karartma (blackout) stor perdeler gün ışığını %100 engellediği için uyku kalitenizi artırır ve mahremiyetinizi korur',
  'Okul ve iş yerlerinde yapılacak sunum veya slayt gösterimleriniz için bulunduğunuz ortamı karartarak daha kullanışlı ve verimli hale getirir',
  'Ev ve ofis uygulamalarına uygundur, tüm mekânlarda gönül rahatlığıyla kullanılabilir',
  'Güneşin yıpratıcı etkisine karşı son derece dayanıklı olan kumaşlar değişen ışık ve ısı kontrol özellikleri ile son derece kullanışlı ve uzun ömürlüdür',
  'Özellikle bakım gerektirmeyen ve temizliği kolay olan perde sistemlerindendir',
  'Mimari ve dekorasyon amaçlı her türlü kullanıma uygundur',
  'Hareketli mekanizması sayesinde dışarıdan gelen gün ışığını kontrol edebilebilir',
  'Suya dayanıklı özel screen kumaşlar ve pvc tercih edildiğinde mutfak, banyo ve kapalı havuz gibi tesislerde de rahatlıkla kullanılabilir',
  'İstenilen renk ve ölçüde tasarlanabilir'
]
...
const usageAreas = [
  ...
  'Sunum odaları',
  'Ev sinema odaları',
  'Gece vardiyası çalışanların evleri'
]
...
export default function KarartmaStorPerdePage() {
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Genellikle ihtiyaca yönelik kumaş seçenekleri tercih edildiği gibi mimari ve dekorasyon amaçlı uygulamalarda
                  mekanlara farklılık katmaktadır. Karartma(Blackout) Stor Perde güneş ışınlarını, sokak lambalarını ve diğer
                  ışık kaynaklarının dışarıdan içeriye sızmasını %100 engeller.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Güneş ısısı yada soğuğa karşı koruyup maksimum seviye de ısı yalıtımı sağlar. Perde mekanizmaları manuel yaylı,
                  zincirli mekanik sistem ve uzaktan kumandalı sistemler olarak istediğiniz model ve ölçüde uygulanabilmektedir.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Kartonpiyerli alanlarda açık kasa, kartonpiyer olmayan alanlarda seçilen kumaş rengine göre kapalı kasa olarak
                  da uygulanabilir.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {['Blackout', '%100 Karartma', 'Işık Geçirmez', 'Isı Yalıtımlı', 'Motorlu Sistem', '36 Ay Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Karartma (Blackout) stor perde fiyatları kumaş cinsine, renk seçeneğine ve mekanizma türüne göre değişiklik göstermektedir.
      ...
      <section className="relative py-20 border-t border-white/5">
        <div className="container mx-auto px-6">
          <ProductGalleryHeading
            ...
            fallbackTitle="Karartma Stor Perde Modelleri"
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Karartma Stor Perde Hakkında Sorularınız mı var?
            </h3>
