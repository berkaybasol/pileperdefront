        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Tül Stor Perde</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Tül Stor Perdeler, Pile Perde garantisiyle kanserojen madde içermeyen 1.sınıf kumaş ve malzemelerden üretilmektedir.
              Tül Stor Perde, transparan yapısıyla iç mekanlarınızda rahatça kullanabileceğiniz bir stor perde türüdür.
            </p>
          </div>
        </div>
      </section>
