...
export const generateMetadata = () => getCmsPageMetadata('product-gallery-urunler-mekanizmali-perdeler-stor-perde-desenli-stor-perde', fallbackMetadata)
...
export default function DesenliStorPerdeLayout({
  ...
  return <CmsPageBoundary pageKey="product-gallery-urunler-mekanizmali-perdeler-stor-perde-desenli-stor-perde">{children}</CmsPageBoundary>
}