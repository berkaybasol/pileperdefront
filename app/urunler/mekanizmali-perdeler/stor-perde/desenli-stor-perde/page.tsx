...
const canonicalUrl = 'https://pileperde.com.tr/urunler/mekanizmali-perdeler/stor-perde/desenli-stor-perde'
const breadcrumbItems: BreadcrumbItem[] = [
  ...
  { name: 'Desenli Stor Perde', url: '/urunler/mekanizmali-perdeler/stor-perde/desenli-stor-perde' },
]
...
const productImages: ProductGalleryImage[] = [
  {
    id: 1,
    src: '/api/public/media/images/aa595e7c-4fa9-41d5-91ce-10cc578e64db/file',
    alt: 'Desenli perde Pile Perde',
    title: 'Desenli Perde Pile Perde'
  },
  {
    id: 2,
    src: '/api/public/media/images/139c5f34-0287-4d29-b06a-e26d459e1758/file',
    alt: 'Desenli stor perde',
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div
                ...
                <div className="space-y-4">
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Dekoratif Desenli Stor Perde ile her zaman içeriden ve dışarıdan hoş bir manzaraya sahip olacaksınız.
                    Bu nedenle, iç mekan dekorasyonuna önem verenler için ideal perde sistemidir.
                  </p>

                  <p className="text-gray-300 text-sm leading-relaxed">
                    İç mekanlarınızdan dışarıya bakışlarınız neredeyse engelsiz bir şekilde dolaşabildiği gibi, dışarıdan
                    evinize yönlendirilen bakışlar da desenli stor perde ile engellenir. Desenli stor perdeler daha fazla
                    gizlilik sağlamak için çeşitli renk ve kumaşlarla kombine edilebilir.
                  </p>

                  <p className="text-gray-300 text-sm leading-relaxed">
                    Çiftli stor perdeler hem desenli stor hem de dijital baskılı stor olarak tek kasada uygulanabilir.
                    Desenli Stor perdeler özel kumaş yapısı sayesinde iç mekanlarda gün ışığını daha yararlı şekilde
                    kullanabilme ve kontrol edebilme konusunda oldukça başarılıdır.
                  </p>

                  <p className="text-gray-300 text-sm leading-relaxed">
                    Bu stor perdeler özellikleri sayesinde güneş ışınlarını kırarlar ve aydınlık bir ortam sağlarlar.
                    Baskılı, renkli veya birçok desen çeşitleri mevcuttur. İç mekânlarınızda kullandığınız Desenli Stor
                    Perdeler yaşadığımız ortamın konforunu maksimum seviyeye çıkartır.
                  </p>

                  <p className="text-gray-300 text-sm leading-relaxed">
                    Kumaş yapıları sayesinde, aydınlatma enerji sarfiyatı konusunda tasarrufu maksimize ederler.
                    İsteğe göre motorlu veya zincir kontrol sistemli üretilebilir.
                  </p>
                </div>

                {/* Features Tags */}
                <div className="flex flex-wrap gap-2 mt-4">
                  {['Desenli Kumaş', 'Baskılı', 'Dekoratif', 'Renkli Seçenekler', 'Motorlu Sistem', '36 Ay Garanti'].map((feature) => (
                    <span
                      key={feature}
              ...
              <div
                ...
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Desenli stor perde fiyatları kumaş cinsine, desen seçeneğine ve mekanizma türüne göre değişiklik göstermektedir.
            ...
            <div
              ...
              {galleryImages.map((image, index) => (
                <div
                  ...
                  className="group">
                  <div
                    className="relative h-[500px] rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-white/5 hover:border-white/20 transition-all duration-500 cursor-pointer"
                    onClick={() => {
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
                Desenli Stor Perde Hakkında Sorularınız mı var?
              </h3>
