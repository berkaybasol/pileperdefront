        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Screen Perde</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Sun Screen Stor Perde iki farklı kumaş türünden üretilmektedir. Birinci kumaş türü cam elyaf üzerine PVC kaplamadır.
              İkinci kumaş türü ise PES screen stor perdedir ve Polyester kumaşlardan üretilir.
            </p>
          </div>
        </div>
      </section>
