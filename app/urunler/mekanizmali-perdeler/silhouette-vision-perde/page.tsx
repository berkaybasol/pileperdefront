...
const productAdvantages = [
  ...
  'Hareketli mekanizması sayesinde dışarıdan gelen gün ışığını kontrol edilebilir',
  'Manuel ve Uzaktan kumandalı ve elektrikli seçenekleri',
  'İstenilen renk ve ölçüde tasarlanabilir',
  '36 ay garantili garanti sonrası servis hizmeti sunulmaktadır'
]

const usageAreas = [
  'Evinizin tüm mekanlarında kullanılabilir',
  'Makam odaları',
  'VIP ofisler',
  'Lüks konutlar',
  'Otel lobiler',
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Kanserojen madde içermeyen kumaş ve malzemelerden üretilmektedir. İç mekanlarınızda gönül rahatlığıyla
                  kullanabileceğiniz özel kumaş yapısı sayesinde, gün ışığını daha yararlı şekilde kullanabilecek ve kontrol
                  edebileceksiniz.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Ortamda bulunan elektronik eşyalar, tekstil ürünleri ve bizlerin UV ışınlarından gördüğü zararları %100&apos;e
                  yakın yok eder. Yaşadığımız ortamın konforunu maksimum seviyeye çıkartır.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Mekanizmaları, manuel zincirli sistem ve motorlu (uzaktan kumandalı) sistemlerle istediğiniz ölçüde
                  projelendirilip uygulanabilmektedir.
                </p>
              </div>

              {/* Features Tags */}
              <div className="flex flex-wrap gap-2 mt-4">
                {['Technical', 'UV Koruma', 'Manuel', 'Motorlu', 'VIP', '36 Ay Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Silhouette & Vision Stor Perde fiyatları, ürün cinsine ve türüne göre değişiklik göstermektedir.
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extralight text-white">
              Silhouette & Vision Perde Modelleri
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Silhouette & Vision perdeler özellikle VIP ofisler, makam odaları ve lüks konutlarda tercih edilir.
                Modern ve şık tasarımı ile her türlü mekana değer katar.
              </p>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Silhouette & Vision Perde Hakkında Sorularınız mı var?
            </h3>
