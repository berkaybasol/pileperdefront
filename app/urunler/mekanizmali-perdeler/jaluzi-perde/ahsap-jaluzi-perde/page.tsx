        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Ahşap Jaluzi Perde</span>
            </div>

            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-6">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
              <span className="text-xs text-gray-400 uppercase tracking-wider">Ahşap Jaluzi Koleksiyonu</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Ahşap Jaluzi Perde, ince şerit bantlarından oluşan ve şeritlerin birbiriyle senkronize hareket etmesini sağlayan bir perde sistemidir.
              25 mm, 35 mm, 50 mm ve 63 mm olarak üretilmektedir. 60 adet değişik renk ve dokuda geniş ürün yelpazesine sahiptir.
            </p>
          </div>
        </div>
      </section>
