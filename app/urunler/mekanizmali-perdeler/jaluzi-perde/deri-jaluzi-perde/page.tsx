...
const productAdvantages = [
  ...
  'Manuel ipli, zincirli sistem ve motorlu uzaktan kumandalı sistemler mevcuttur.',
  'Gün ışığının miktarını dilediğiniz gibi kontrol edebilmenizi sağlar.',
  'Zigıl sistemi sayesinde hareketli kapı ve pencerelerin çarpmalarını engelleyici özelliği vardır.',
  'Estetiğe önem veren müşterilerimiz için sıra dışı, bir koleksiyon.',
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Deri Jaluzi Perde mekanizmaları, manuel ipli, zincirli sistem ve motorlu uzaktan kumandalı sistemler
                  olarak ayrılmaktadır. Dilediğiniz ölçüde uygulanabilmektedir. Hareket mekanizması sayesindeki işlevselliği ile
                  dışarıdan gelen gün ışığına yön verebilir ve istenilen ışık miktarını kontrol edebilirsiniz.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Zigıl sistemi sayesinde hareketli kapı ve pencerelerin çarpmalarını engelleyici özelliği vardır.
                  Eğimli ve oval pencereler için de kullanılabilir. Estetiğe önem veren müşterilerimiz için sıra dışı, bir koleksiyon.
                </p>
              </div>

              {/* Features Tags */}
              <div className="flex flex-wrap gap-2 mt-4">
                {['50mm', 'Suni Deri', 'El İşçiliği', 'Zigıl Sistemi', 'Motorlu Sistem', '36 Ay Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            >
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Deri Jaluzi Perde fiyatları, ürün cinsine ve türüne göre değişiklik göstermektedir.
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Deri Jaluzi Perde Hakkında Sorularınız mı var?
            </h3>
