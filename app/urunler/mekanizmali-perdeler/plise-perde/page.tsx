...
const productAdvantages = [
  ...
  'İster yukardan aşağı, ister aşağıdan yukarı, isterseniz her iki yönden de açabilirsiniz',
  'Çatı ve tavanlarınızda gün ışığından en üst düzeyde faydalanmanızı sağlar',
  'Kış bahçesi, çatı katı ve balkonlarınızda şık ve modern bir görünüm sağlar',
  'Eğik pencerelerde sarkma yapmadan mükemmel uyum gösterir',
  'Çok sayıda kumaş ve renk seçeneği ile her dekora uyum sağlar',
  'Dayanıklı mekanizma sayesinde uzun yıllar sorunsuz kullanım',
  'Kolay temizlenir, kir ve toz tutmaz',
  '36 ay garantilidir'
]

const usageAreas = [
  'Çatı katı odalar ve mansardlar',
  'Eğik pencereler ve velux tipi pencereler',
  'Kış bahçeleri ve camlı tavanlar',
  'Balkonlar ve teraslar',
  'Ofis çatı katları',
  'Yatak odaları ve çalışma odaları',
  'Kafeler ve restoranlar',
  'Otel lobiler ve suit odaları'
]
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Plise perde, çatı katı odalarınızda, eğik pencerelerde ve tavan pencerelerinde mükemmel çözümler sunar.
                  Özel mekanizması sayesinde her iki yönde de açılıp kapanabilir ve istenilen konumda sabitlenebilir.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Kış bahçelerinde ve balkonlarda gün ışığından maksimum düzeyde yararlanmanızı sağlarken, aynı zamanda
                  modern ve şık bir görünüm sunar. Geniş renk ve kumaş seçenekleriyle her dekora uyum sağlar.
                </p>
              </div>

              {/* Features Tags */}
              <div className="flex flex-wrap gap-2 mt-4">
                {['Çatı Perdesi', 'Eğik Pencere', 'Kış Bahçesi', 'Çift Yönlü', 'Modern', '36 Ay Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Plise Perde fiyatları, ürün cinsine, türüne ve ölçülere göre değişiklik göstermektedir. Pile Perde,
                rekabetçi fiyatları ile projelerinizi sorunsuz şekilde tamamlamanızı sağlar.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Plise perdeler özellikle çatı katı odalarınızda, eğik pencerelerde, kış bahçelerinde ve balkonlarınızda
                tercih edilir. Modern tasarımı ile her türlü mekana uyum sağlar.
              </p>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Plise Perde Hakkında Sorularınız mı var?
            </h3>
