...
const productAdvantages = [
  'Dikey Perde sistemleri kalitesi, sağlamlığı, kullanım kolaylığı ile kullanıcıya avantaj sağlamaktadır',
  'Zengin sıradışı şık tasarımlar oluşturmanızı sağlar',
  'Çift taraflı olduğundan; dikey perde kapalı durumdayken, nemli bir bez ile kolayca silinip tozu alınabilir',
  'Gün ışığının miktarını dilediğiniz gibi kontrol edebilmenizi sağlar',
  '36 ay garantili garanti sonrası servis hizmeti sunulmaktadır'
]
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Dikey Perde</span>
            </div>

            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-6">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
              <span className="text-xs text-gray-400 uppercase tracking-wider">Dikey Perde Koleksiyonu</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Dikey perde, mekanik sistem perdeler içerisinde kullanım şeklinin pratikliği ve ürün çeşitliliği nedeniyle
              en çok Resmî kurumlar, Ofis, büro gibi mekanlarda tercih edilen iç cephe perde sistemleridir. PVC slayt, kumaş,
              screen, olmak üzere geniş renk seçenekleri ile birçok tül ve kumaş çeşitlerinden ışık geçirmeyen Karartma
              (blackout) kumaşlara kadar çok geniş bir koleksiyona sahiptir.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Ev kullanımı için üretilen birçok çeşidi vardır. Genellikle ihtiyaca yönelik kumaş seçenekleri tercih edildiği
                  gibi mimari ve dekorasyon amaçlı uygulamalarda da mekanlara farklılık katmaktadır.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Dikey perde alırken kesinlikle amacınıza uygun kaliteli anti bakteriyel kumaşlar tercih etmelisiniz. Dikey perde
                  mekanizmaları, zincirli mekanik sistem ve uzaktan kumandalı Motorlu sistemler olarak dilediğiniz ölçüde
                  uygulanabilmektedir.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  PVC Dikey Perde slaytları 89 mm. Kumaş Dikey perde Slaytları, 89 mm ve 127 mm üretilebilmektedir. Dikey perde,
                  üstten kayan bir ray üzerine tutturulmuş slaytlardan ve perdenin altındaki ağırlıklar ile dengeleyici zincirlerden
                  oluşur. Her bir slayt dikey olarak asılı durmaktadır.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  İki mekanizması vardır. Mekanizma zinciri çekildiğinde, şeritler birbiriyle senkronize hareket eder, İp Mekanizması
                  çekildiğinde sağa, sola yada ortadan ikiye ayrılarak toplanan bir perde sistemidir. Dikey eğimli ve oval pencerelerde
                  uygulanabilir.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {['PVC Slayt', 'Kumaş 89mm-127mm', 'Screen', 'Blackout', 'Motorlu Sistem', '36 Ay Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Dikey perde fiyatları, ürün cinsine ve türüne göre değişiklik göstermektedir. Pile Perde, rekabetçi fiyatları
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Dikey Perde Hakkında Sorularınız mı var?
            </h3>
