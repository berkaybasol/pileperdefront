...
const productImages: ProductGalleryImage[] = [
  { id: 1, src: '/api/public/media/images/f2650670-4cce-458e-9d01-9690f82673ce/file', alt: 'Projeksiyon perde Ankara', title: 'Projeksiyon Perde Ankara' },
  { id: 2, src: '/api/public/media/images/00b5a253-4ff1-4072-a186-9a6e5c8cfb4a/file', alt: 'Somfy projeksiyon perde', title: 'Somfy Projeksiyon Perde' }
]

const PRODUCT_GALLERY_PAGE_KEY = 'product-gallery-urunler-motorlu-perdeler-projeksiyon-perde'

const productAdvantages = [
  'Güneş, rüzgar, yağmur ve toza karşı yüksek koruma sağlar',
  'Uzaktan kumanda veya akıllı telefon ile kolayca kontrol edilebilir',
  'Dış mekan alanlarınızı konforlu yaşam alanlarına dönüştürür',
  'Enerji tasarrufu sağlayan özel kumaş teknolojisi',
  '5 yıl garantili Somfy motor sistemi ile sunulmaktadır'
]

const usageAreas = [
  'Balkon ve Teras alanları',
  'Restaurant ve Kafe dış alanları',
  'Otel ve Konaklama tesisleri',
  'Dış Cephe uygulamaları',
  'Pergola ve Kış bahçeleri',
  'Villa ve Rezidans dış mekanları',
  'Alışveriş merkezi açık alanları',
  'Kurumsal bina dış cepheleri'
]
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Projeksiyon Perde</span>
            </div>

            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-6">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
              <span className="text-xs text-gray-400 uppercase tracking-wider">Dış Mekan Sistemleri</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Dış mekan alanlarınızı konforlu yaşam alanlarına dönüştüren motorlu projeksiyon perde sistemleri.
              Güneş, rüzgar ve yağmura karşı maksimum koruma ile balkon, teras ve dış cephe uygulamalarında
              mükemmel çözüm sunmaktadır.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm leading-relaxed">
                  Projeksiyon perde sistemleri, balkon ve teras gibi dış mekan alanlarınızda güneş kontrolü ve
                  mahremiyet sağlayan motorlu perde çözümleridir. Somfy motor teknolojisi ile donatılmış sistemler,
                  uzaktan kumanda veya akıllı telefon uygulaması ile kolayca kontrol edilebilir.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Rüzgar sensörü ve güneş sensörü gibi akıllı otomasyon sistemleri ile entegre edilebilir.
                  Hava koşullarına göre otomatik olarak açılıp kapanabilen sistemler, enerji tasarrufu sağlarken
                  mekanınızın güvenliğini de korur.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Dayanıklı alüminyum kasalar ve özel üretim su geçirmez kumaşlar ile üretilen projeksiyon perdeler,
                  yıllarca sorunsuz kullanım imkanı sunar. UV filtreli kumaşlar sayesinde iç mekanınızı güneşin
                  zararlı etkilerinden korurken, serin bir ortam elde edersiniz.
                </p>

                <p className="text-gray-300 text-sm leading-relaxed">
                  Restoran, kafe, otel gibi ticari alanların dış mekanlarında sıkça kullanılan projeksiyon perdeler,
                  müşteri memnuniyetini artırırken, kullanılabilir alan kazandırır. Villa ve rezidanslarda da
                  yaşam konforunu üst seviyeye taşır.
                </p>
              </div>

              {/* Features Tags */}
              <div className="flex flex-wrap gap-2 mt-4">
                {['Somfy Motor', 'Uzaktan Kumanda', 'Akıllı Kontrol', 'Rüzgar Sensörü', 'UV Korumalı', '5 Yıl Garanti'].map((feature) => (
                  <span
                    key={feature}
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Projeksiyon perde fiyatları, kumaş cinsi, motor tipi ve alan ölçülerine göre değişiklik göstermektedir.
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Projeksiyon perdeler, dış mekan alanlarının konforunu artırmak ve güneş kontrolü sağlamak için
                ideal çözümlerdir. Hem konut hem de ticari projelerde geniş kullanım alanına sahiptir.
              </p>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extralight text-white mb-4">
              Projeksiyon Perde Hakkında Sorularınız mı var?
            </h3>
