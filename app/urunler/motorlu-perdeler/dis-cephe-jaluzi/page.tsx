        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Dış Cephe Jaluzi</span>
            </div>

            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-6">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
              <span className="text-xs text-gray-400 uppercase tracking-wider">Güneş Kontrol Sistemleri</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Otomatik dış cephe jaluzi sistemleri ile binanızda enerji tasarrufu ve güneş kontrolü sağlayın.
              Alüminyum lamelli brisoley sistemler ile estetik ve fonksiyonel çözümler.
            </p>
          </div>
        </div>
      </section>
