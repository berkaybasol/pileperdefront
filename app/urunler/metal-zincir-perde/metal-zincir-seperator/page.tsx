...
const canonicalUrl = 'https://pileperde.com.tr/urunler/metal-zincir-perde/metal-zincir-seperator'
const breadcrumbItems: BreadcrumbItem[] = [
  { name: 'Ana Sayfa', url: '/' },
  { name: 'Ürünler', url: '/urunler' },
  { name: 'Metal Zincir Perde', url: '/urunler/metal-zincir-perde' },
  { name: 'Metal Zincir Seperatör', url: '/urunler/metal-zincir-perde/metal-zincir-seperator' },
]

const fallbackMetadata: Metadata = {
  alternates: { canonical: 'https://pileperde.com.tr/urunler/metal-zincir-perde/metal-zincir-seperator' },
