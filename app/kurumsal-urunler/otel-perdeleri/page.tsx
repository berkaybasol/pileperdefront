        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-sm text-gray-400">Otel Perdeleri</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-light leading-relaxed max-w-3xl mx-auto">
              Oteller ve iş merkezleri için profesyonel perde çözümleri. Işık kontrolü, gürültü azaltma ve estetik tasarım ile
              çalışma verimliliğini artıran, makam odası ve bürolara özel perde sistemleri.
            </p>
          </div>
        </div>
      </section>
